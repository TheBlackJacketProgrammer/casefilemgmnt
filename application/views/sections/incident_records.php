<section class="incident-records-section" ng-controller="RecordsController">
    <div class="header">
        ...
        <table id="tbl_records" class="min-w-full divide-y divide-gray-200" datatable="ng" dt-options="dtOptions" dt-instance="dtInstance">
            ...
            <tbody>
                <tr ng-repeat="record in records">
                    ...
                    <td class="px-6 py-4">{{ record.case_status }}</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <?php $this->load->view('components/modals/modal_crime_options'); ?>
</section>